...
{/**Job Status Actions */}
{currentStatus==="not-applied" && <TouchableOpacity onPress={()=>{markStatus('applied')}} style={{flexDirection:'row', borderRadius:20, alignItems:'center', justifyContent:'center', padding:10, margin:5,marginTop:35, backgroundColor:'#075ba6' }}>
